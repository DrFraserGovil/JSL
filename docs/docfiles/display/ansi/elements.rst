...
These enums are largely hidden from the user (they are used internally to encode, i.e. the difference between :cpp:func:`JSL::Format::Black` and :cpp:func:`JSL::Format::Bold`), but they may be encountered in the :cpp:func:`JSL::Format::Reset` function.