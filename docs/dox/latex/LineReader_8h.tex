\hypertarget{LineReader_8h}{}\doxysection{/\+Users/jf20/\+Documents/\+JSL/\+File\+IO/\+Line\+Reader.h File Reference}
\label{LineReader_8h}\index{/Users/jf20/Documents/JSL/FileIO/LineReader.h@{/Users/jf20/Documents/JSL/FileIO/LineReader.h}}
...
\DoxyCodeLine{        \{                           \mbox{\hyperlink{namespaceJSL_a5783bc90550deca94c1790e581fb707d}{\(\backslash\)}}}
\DoxyCodeLine{\mbox{\hyperlink{namespaceJSL_a5783bc90550deca94c1790e581fb707d}{            JSL::Error}}(\mbox{\hyperlink{namespaceJSL_a5059dbafa288b9b3beac1746f4acae61a7da39e712d8960d161fbef3305d793a4}{JSL::IOError}},\textcolor{stringliteral}{"{}Could not find the file '"{}} + macroFileName + \textcolor{stringliteral}{"{}.\(\backslash\)n\(\backslash\)nPlease provide a valid filepath."{}});\(\backslash\)}
\DoxyCodeLine{        \}                           \(\backslash\)}
...
\end{DoxyCode}
Iterates through the file line-\/by-\/line (until EOF), saving the current line to {\ttfamily std\+::string FILE\+\_\+\+LINE}, and then tokenises it using \mbox{\hyperlink{namespaceJSL_aa37a5ffd99a34e2f12377c9f00b31c50}{split()}}, based on the chosen delimiter, saving it to {\ttfamily std\+::vector\texorpdfstring{$<$}{<}std\+::string\texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>} FILE\+\_\+\+LINE\+\_\+\+VECTOR} 
\begin{DoxyParams}{Parameters}
{\em macro\+File\+Name} & The target file to search through \\
\hline
