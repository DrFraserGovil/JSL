...
namespace JSL::String
{
	...
	*/
	...
	template <typename T>
	std::string inline makeFrom(const T &obj)
		requires JSL::Concept::StringLike<T>
	{
	...
	*/
	 ...
	 */
	template <typename T>
	std::string inline makeFrom(const T &val, int precision, std::chars_format fmt = std::chars_format::scientific)
		requires JSL::Concept::Integer<T>
	{
	...
	std::string inline makeFrom(const T &ptr)
		requires JSL::Concept::SmartPtr<T>;
	/////////////////////////
	// Containers
	/////////////////////////
	...
	*/
		...
		requires JSL::Concept::OptionalLike<T>
	{
		if (!opt)
		{
			return JSL_NULL_STRING;
		}
		else
		{
			return makeFrom(opt.value());
		}
	}
