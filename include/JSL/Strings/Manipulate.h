...
namespace JSL::String
{
    ...
    */
    ...
    //! @warning The output a string_view - references to the original string. This has the limitation that the output is only meaningful so long as the original string survives. Copies out of the string_view do persist, or use trim.
