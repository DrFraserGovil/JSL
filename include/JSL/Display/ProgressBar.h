	...
	namespace internal
	{
		...
		class ProgressEngine
		{
		  public:
			...
			void SetPrefix(std::string prefix, size_t idx);
			void SetPrefix(std::vector<std::string> &prefixes);
			void SetSuffix(std::string suffix);
			void SetSuffix(std::string suffix, size_t idx);
			void SetSuffix(std::vector<std::string> &suffixess);
