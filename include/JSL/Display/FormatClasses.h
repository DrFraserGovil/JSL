...
namespace JSL::Display
{
	...
	*/
	...
	/*!
		...
		@warning Converts sequences to a blank string when JSL::Display::Terminal reports a non-ANSI output stream, preventing garbling of escape sequences.
	*/
	class Format
	{
	  public:
