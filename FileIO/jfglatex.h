...
namespace JSL
{
	void inline jfglatex(std::string filename, std::string compilename, bool openfile, bool quietmode)//a C++ implementation of my jfglatex bash script, to prevent carting it around
	{
